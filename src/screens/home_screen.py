...
def home_screen():
    ...
    st.markdown("""
        <div style="text-align: center; margin: 1.5rem 0 2.5rem 0;">
            <div style="display: inline-block; background: rgba(88, 101, 242, 0.12); border: 1px solid rgba(88, 101, 242, 0.3); padding: 6px 18px; border-radius: 100px; color: #a5b4fc; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 1rem;">
                ✨ AI-Powered Biometric Attendance & Classroom Analytics
            </div>
            <h1 style="color: #ffffff; font-size: 2.8rem; line-height: 1.15; margin-bottom: 1rem;">
            ...
            <p style="color: #94a3b8; font-size: 1.1rem; max-width: 720px; margin: 0 auto 1.5rem auto; line-height: 1.6;">
    ...
    with st.container():
        st.markdown("""
            <div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 18px; padding: 1.2rem 1.8rem; margin-bottom: 2.5rem; box-shadow: 0 8px 24px rgba(0,0,0,0.2);">
                <div style="font-weight: 700; color: #f8fafc; font-size: 1.05rem; margin-bottom: 0.5rem; display: flex; align-items: center; gap: 8px;">
    ...
    st.markdown("""
        <div style="margin-top: 3.5rem; text-align: center;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.2rem; text-align: left;">
                <div style="background: rgba(30, 41, 59, 0.6); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 16px; padding: 1.4rem;">
                    <div style="font-size: 1.8rem; margin-bottom: 0.5rem;">⚡</div>
                    <div style="font-weight: 700; color: #f8fafc; font-size: 1.05rem; margin-bottom: 0.3rem;">Multi-Face Attendance</div>
                    <div style="color: #94a3b8; font-size: 0.86rem; line-height: 1.5;">Recognize multiple students in a single classroom frame simultaneously in milliseconds using 128-d dlib embeddings.</div>
                </div>
                <div style="background: rgba(30, 41, 59, 0.6); border: 1px solid rgba(255, 255, 255, 0.06); border-radius: 16px; padding: 1.4rem;">
